...
# ----------------------
  ...
  it '3. finds order id of largest order' do
    ...
    # Solution goes here
    # Your solution should not contain the ID of the order anywhere
    order_id = Order.order(amount: :desc)
                    .limit(1)
                    .first
                    .id
    # ------------------------------------------------------------
  ...
  it "13. groups an order's items by name" do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    grouped_items = Order.find(@order_3.id)
                         .items
                         .order(:name)
    # ------------------------------------------------------------
...
# ========================
  ...
  it '20. returns the average amount for all orders for one user' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    average = Order.where(user_id: @user_3)
                   .average(:amount)
    # ------------------------------------------------------------
...
# ========================
  ...
  it '22. calculates the total sales for all but one user' do
    ...
    # ------------------ Using ActiveRecord ---------------------
    # Solution goes here
    total_sales = Order.where.not(user_id: @user_2)
                       .sum(:amount)
    # -----------------------------------------------------------
  ...
  it '24. returns all orders for user 2 which include item_4' do
    ...
    #  Solution goes here
    orders = Order.joins(:items)
                  .where(user_id: @user_2, items: { id: @item_4 })
    # -----------------------------------------------------------
...
# ========================
  ...
  it '28. returns a table of information for all users items' do
    ...
    custom_results = User.joins(:order_items)
                          .select('users.name, count(order_items.id) as total_item_count')
                          .group('users.name')
                          .order(name: :desc)
    # ---------------------------------------------------------------
